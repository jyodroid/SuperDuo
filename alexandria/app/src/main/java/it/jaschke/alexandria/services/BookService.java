...
public class BookService extends IntentService {
    ...
    private void fetchBook(String ean) {
        ...
        //If there is no internet connection return message
        if (!InternetUtils.isInternetAvailable(getBaseContext())){
            Intent messageIntent = new Intent(MainActivity.MESSAGE_EVENT);
            messageIntent.putExtra(MainActivity.MESSAGE_KEY,getResources().getString(R.string.not_internet_available));
